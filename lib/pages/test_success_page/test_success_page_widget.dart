...
import 'test_success_page_model.dart';
...
class _TestSuccessPageWidgetState extends State<TestSuccessPageWidget> {
  late TestSuccessPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TestSuccessPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.streamBlockfinApiOutput = await StreamBlockfinAPICall.call();
      if (_model.streamBlockfinApiOutput?.succeeded ?? true) {
        final streamSubscription = _model
            .streamBlockfinApiOutput?.streamedResponse?.stream
