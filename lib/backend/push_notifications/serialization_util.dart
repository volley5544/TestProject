...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case ConversationMembersRow:
        return ConversationMembersRow(
            json.decode(param) as Map<String, dynamic>) as T;
      case ProfilesRow:
        return ProfilesRow(json.decode(param) as Map<String, dynamic>) as T;
      case MessageReadsRow:
        return MessageReadsRow(json.decode(param) as Map<String, dynamic>) as T;
      case MessagesRow:
      ...
      case MessageReactionsRow:
        return MessageReactionsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case MessageAttachmentsRow:
        return MessageAttachmentsRow(json.decode(param) as Map<String, dynamic>)
            as T;
